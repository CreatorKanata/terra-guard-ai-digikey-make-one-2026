...
1本からパースし、1つのウィンドウに左=サーマル(32×24)、右=距離(8×8)を並べて
リアルタイム表示する。
...
オプション:
    ...
    --baud 115200
    --t-vmin 15 --t-vmax 35      サーマル温度スケール[℃]
...
def parse_args():
    ...
    p.add_argument("--t-vmax", type=float, default=35.0, help="サーマル温度上限[℃]")
...
def main():
    ...
    plt.ion()
    fig, (ax_t, ax_d) = plt.subplots(1, 2, figsize=(11, 5), dpi=100)
