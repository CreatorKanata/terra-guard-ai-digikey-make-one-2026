...
本リポジトリは **DigiKey Make ONE Challenge 2026** 向けの実装である。NXP FRDM-MCXN947 を中心としたセンサフュージョンとエッジAI処理による害鳥・害獣検知＋追い払いを実装する。プロトタイプ段階のセンサ取得・可視化は Freenove Control Board V5（ESP32）で行う。
...
| [esp32-firmware.md](./esp32-firmware.md) | ESP32 (PlatformIO) ファームウェアの使い方 |

---

## クイックスタート（ESP32 プロトタイプ）
...
詳細は [esp32-firmware.md](./esp32-firmware.md) を参照。
